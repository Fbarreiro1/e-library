...
console.log("CheckoutAndReviewBox component is rendering");
export const CheckoutAndReviewBox: React.FC<{
    book: BookModel | undefined;
    mobile: boolean;
    currentLoansCount: number;
    isAuthenticated?: boolean; // Permitir undefined
    isCheckedOut: boolean;
    checkoutBook: () => void;
    isReviewLeft?: boolean; // Permitir undefined
    ...
    return (
        <div className={props.mobile ? 'card d-flex mt-5' : 'card col-3 container d-flex mb-5'}>
            <div className='card-body container'>
                <div className='mt-3'>
                    <p><b>{props.currentLoansCount}/5 </b> books checked out</p>
                    <hr />
